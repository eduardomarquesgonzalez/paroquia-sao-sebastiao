...
export default function NewsletterPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-parish-text">Newsletter</h1>
        <p className="text-parish-text-light mt-1">Gerenciamento de assinantes e envio de comunicados</p>
      </div>
      ...
      <div className="bg-parish-surface rounded-lg border border-parish-border p-16 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-parish-text-light max-w-md">
          O módulo de newsletter está sendo desenvolvido e estará disponível em breve.
        </p>
      </div>
    </div>
  );
