...
export default function EditarSacramentoPage() {
  ...
  useEffect(() => {
    async function load() {
      try {
        const res = await fetch(`/api/sacramentos?id=${id}`);
        ...
        setRequiredDocuments(data.requiredDocuments?.length ? data.requiredDocuments : [""]);
      } catch {
        toast.error("Erro ao carregar sacramento");
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Sacramento atualizado!");
      router.push("/admin/sacramentos");
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-parish-text">Editar Sacramento</h1>
