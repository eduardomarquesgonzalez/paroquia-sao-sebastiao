    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-parish-text">Novo Movimento / Pastoral</h1>
            <p className="text-parish-text-light mt-1">Cadastre as informações do grupo</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-parish-surface rounded-lg shadow-sm p-6 border border-parish-primary space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-parish-text-light mb-2">Nome do Movimento / Pastoral *</label>
              <input
                type="text" name="name" value={formData.name} onChange={handleChange}
                placeholder="Ex: Pastoral da Criança, Legião de Maria..."
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Descreva o movimento/pastoral, sua missão e atividades..."
